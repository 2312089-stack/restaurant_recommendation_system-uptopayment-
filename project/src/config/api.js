 ...
 */
// ✅ FIXED: Different URLs for development vs production
export const API_BASE_URL = isDevelopment
  ? 'http://localhost:5000/api'  // Development - LOCAL with /api
  : (import.meta.env.VITE_API_URL ||
     import.meta.env.VITE_API_BASE_URL ||
     'https://tastesphere-hy30.onrender.com/api'); // Production

export const BACKEND_URL = isDevelopment
  ? 'http://localhost:5000'  // Development - LOCAL
  : (import.meta.env.VITE_BACKEND_URL ||
     'https://tastesphere-hy30.onrender.com'); // Production
