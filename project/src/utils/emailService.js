          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center;">
                <a href="http://localhost:5173/help-center" class="button">Visit Help Center</a>
              </div>
            </div>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="color: #666; font-size: 16px; line-height: 1.6;">
                You can track your ticket status and add messages by replying to this email or visiting your account dashboard.
              </p>

              <div style="background-color: #fff7ed; padding: 20px; border-radius: 8px; margin: 20px 0;">
                <p style="margin: 0; color: #666; font-size: 14px;">
                  <strong>Need urgent help?</strong><br>
                  📞 Call us: +91 84288 17940 (24/7)<br>
    ...
    const adminMailOptions = {
      ...
      html: `
        ...
        <body style="font-family: Arial, sans-serif; padding: 20px;">
          ...
          <p style="margin-top: 20px; color: #666;">
            Please review and respond to this ticket promptly.
          </p>
        </body>
        </html>
      `
