...
const PaymentPage = () => {
  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      ...
      const orderResponse = await fetch(buildApiUrl('/payment/create-order'), {
        method: 'POST',
        headers: {
  ...
  const verifyPayment = async (razorpayResponse, order, orderDetails) => {
    ...
    try {
      ...
      const verifyResponse = await fetch(buildApiUrl('/payment/verify-payment'), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleCODPayment = async () => {
    ...
    try {
      ...
      const response = await fetch(buildApiUrl('/payment/create-cod-order'), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
