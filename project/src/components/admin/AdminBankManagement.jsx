...
const AdminBankManagement = () => {
  ...
  const loadStats = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/admin/bank-details/stats`, {
        headers: {
  ...
  const loadSellers = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/admin/bank-details${statusParam}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleVerify = async (sellerId, verified, notes = '') => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/admin/bank-details/${sellerId}/verify`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const viewDetails = async (sellerId) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/admin/bank-details/${sellerId}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
