...
const PaymentSuccessPage = () => {
  ...
  const messageNotificationStatus = notifications?.message || notifications?.whatsapp;
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="border rounded-lg p-4 mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-right">
                <p className="font-bold text-gray-900">Rs.{order.item?.price || order.totalAmount}</p>
              </div>
            </div>
          </div>
                ...
                <>
                  <div className="flex items-center text-blue-700">
                    <div className={`w-4 h-4 mr-2 ${notifications.email === 'sent' ? 'text-green-600' : 'text-red-500'}`}>
                      {notifications.email === 'sent' ? <CheckCircle className="w-4 h-4" /> : 'X'}
                    </div>
                    <span>
                  ...
                  <div className="flex items-center text-blue-700">
                    <div className={`w-4 h-4 mr-2 ${messageNotificationStatus === 'sent' ? 'text-green-600' : 'text-red-500'}`}>
                      {messageNotificationStatus === 'sent' ? <MessageSquare className="w-4 h-4" /> : 'X'}
                    </div>
                    <span>
                      Message update {messageNotificationStatus === 'sent' ? 'sent successfully' : 'failed'}
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p>- Track your order status via email and message updates</p>
